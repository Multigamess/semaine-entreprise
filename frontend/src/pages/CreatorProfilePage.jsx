              ...
              <div className="flex items-center justify-between mt-3">
                ...
                {recipe && (
                  <button
                    ...
                    className="flex items-center gap-1.5 text-[#86BC25] border border-[#86BC25]/30 hover:bg-[#86BC25]/10 rounded-full px-3 py-1 text-xs font-medium transition-colors"
                  >
